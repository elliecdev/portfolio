...
export const experienceEn: ExperienceItem[] = [
  {
    ...
    description: [
      ...
      "Guided migration from a monolith to 15+ AWS microservices, improving scalability and release speed.",
      "Improved delivery quality by introducing AI-assisted development practices and observability tooling.",
      "Partnered with stakeholders to align priorities and translate goals into clear technical roadmaps.",
    ],
    tech: [
      "TypeScript",
      "Angular",
  ...
  },
  {
    ...
    description: [
      "Managed cross-functional, distributed teams delivering PHP, TypeScript, and Python projects.",
      "Implemented CI/CD automation and Agile frameworks, improving delivery efficiency by 30%.",
      "Drove end-to-end delivery by facilitating technical discussions and aligning solutions with business goals.",
    ],
